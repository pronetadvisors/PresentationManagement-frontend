          ...
          <div class="flex">
            ...
            >
              <font-awesome-icon
                ...
                class="w-5 h-5 absolute ml-3 mt-1 pointer-events-none"
              />
              <input
                v-model="search"
                type="search"
                placeholder="Search..."
                class="pl-10 pr-3 mt-1 block w-full px-3 py-2 bg-zinc-400 border border-zinc-600 rounded-md text-sm text-zinc-300 shadow-sm placeholder-zinc-600 focus:outline-none focus:border-zinc-500 disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none invalid:border-pink-500 invalid:text-pink-600 focus:invalid:border-pink-500 focus:invalid:ring-pink-500"
              />
            </label>
            <label
              for="room"
            ...
            >
              ...
              >
                ...
                <option value="Without Presentation" selected>
            ...
            <tbody>
              ...
              >
                ...
                <td class="text-sm text-gray-900 font-light px-6 py-4">
                  {{ new Date(presentation.time).getMonth() + 1 }}/{{
                    new Date(presentation.time).getDate()
                  }}/{{ new Date(presentation.time).getFullYear() }}
                </td>
                <td class="text-sm text-gray-900 font-light px-6 py-4">
                  {{
                ...
                >
                  ...
                  <svg
                    v-else-if="uploading.includes(presentation.id)"
                    class="inline ml-4 w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600 dark:fill-gray-300"
                    viewBox="0 0 100 101"
                    fill="white"
