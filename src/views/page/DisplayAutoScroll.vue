...
<!-- STEVE injected a containing DIV for the 'scrollarea', and subsections of slot-1, slot-2, slot-3 classes as scroll targets -->
...
<style scoped>
/* STEVE additional slot- style */
[class^=slot-]{
  margin-bottom:10px;
}
/* STEVE end style for autoscroll */
li{
  cursor: pointer;
}
