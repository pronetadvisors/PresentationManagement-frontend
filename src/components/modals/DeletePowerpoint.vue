<template>
  <button @click="openModal">
    <font-awesome-icon
      :icon="['fa', 'xmark']"
      class="ml-6 w-6 h-6 text-red-500 transition duration-200 hover:scale-125"
    />
  </button>
      ...
      <div class="relative p-4 w-full h-full md:h-auto">
        ...
        <div class="py-6 px-6 lg:px-8 text-center">
          ...
          <div class="space-y-6 mt-5">
            ...
            <button
              class="w-1/3 text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-400 dark:hover:bg-red-500 dark:focus:ring-red-800"
              @click="onDelete"
            >
              Delete
            </button>
