        ...
        <div class="py-6 px-6 lg:px-8 text-left">
          ...
          <form class="space-y-6">
            <div class="flex justify-center items-center w-full mt-2 mb-2">
              <label
                :for="`dropzone-powerpoint-${props.presentation.session_id}`"
              ...
              >
                ...
                <input
                  :id="`dropzone-powerpoint-${props.presentation.session_id}`"
                  ref="file"
                  type="file"
                  class="hidden"
                  accept="*"
...
const handlePPUpload = async () => {
  ...
  await presentationStore.uploadPowerpoint(
    props.presentation.session_id,
    formData
  );
  isOpen.value = false;
};
